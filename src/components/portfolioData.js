...
const toolsData = [
    ...
    },
    {
        toolName: "VS Code",
        color: "#0078d7",
        toolLogo: { img: true, logo: "https://res.cloudinary.com/pic-gallary/image/upload/v1647589410/my-portofolio/visual-studio-code_uise6a.svg" },
        delay: 0.9,
        animationDiriction: "right",
        toolLogoWidth: 100
    }
...
const projectsData = [
    {
        ...
        direction: "left",
        liveSiteLink: "https://pizza-house.vercel.ap",
    ...
    },
    {
        ...
        backgroundColor: [
            '#6441A5',
            '-webkit-linear-gradient(to right, #2a0845, #290652)',
            'linear-gradient(to right, #2a0845, #290652)'
        ],
        projectImgs: [
...
export { skillsData, toolsData, projectsData }